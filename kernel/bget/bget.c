...
#define SizeQuant   (0x1000 + 8)	      	      /* Buffer allocation size quantum:
					 all buffers allocated are a
					 multiple of this size.  This
					 MUST be a power of two. */

/*#undef BufDump     1*/	      /* Define this symbol to enable the
...
/*#undef DumpData    1*/ 		      /* Define this symbol to enable the
